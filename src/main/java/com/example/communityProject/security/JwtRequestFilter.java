...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            ...
            Long userId = null;
            String jwt = null;
            String role = null; // Role variable to hold the extracted role

            if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
                jwt = authorizationHeader.substring(7);
                userId = jwtUtil.extractUserId(jwt);
                role = "ROLE_" + jwtUtil.extractRole(jwt); // Extract role from token
            }
            ...
            if (userId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (jwtUtil.validateToken(jwt, userId)) {
                    ...
                    authorities.add(new SimpleGrantedAuthority(role)); // Add the extracted role as an authority
